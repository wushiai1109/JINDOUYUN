...
public interface JindouyunStorageMapper {
     ...
     * @mbg.generated
     */
    JindouyunStorage selectOneByExample(JindouyunStorageExample example);
     ...
     * @mbg.generated
     */
    JindouyunStorage selectOneByExampleSelective(@Param("example") JindouyunStorageExample example, @Param("selective") JindouyunStorage.Column ... selective);
     ...
     * @mbg.generated
     */
    List<JindouyunStorage> selectByExampleSelective(@Param("example") JindouyunStorageExample example, @Param("selective") JindouyunStorage.Column ... selective);
     ...
     * @mbg.generated
     */
    JindouyunStorage selectByPrimaryKeySelective(@Param("id") Integer id, @Param("selective") JindouyunStorage.Column ... selective);
     ...
     * @mbg.generated
     */
    JindouyunStorage selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id, @Param("andLogicalDeleted") boolean andLogicalDeleted);
     ...
     * @mbg.generated
     */
    int logicalDeleteByExample(@Param("example") JindouyunStorageExample example);
