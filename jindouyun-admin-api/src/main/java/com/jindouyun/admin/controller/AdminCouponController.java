...
public class AdminCouponController {
    ...
    public Object list(String name, Integer type, Short status,
        ...
        List<JindouyunCoupon> couponList = couponService.querySelective(name, type, status, page, limit, sort, order);
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JindouyunCoupon coupon) {
...
//        }
    ...
    public Object read(@NotNull Integer id) {
        JindouyunCoupon coupon = couponService.findById(id);
        return ResponseUtil.ok(coupon);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JindouyunCoupon coupon) {
        Object error = validate(coupon);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JindouyunCoupon coupon) {
